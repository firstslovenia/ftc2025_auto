...
public class FConstants {
    static {
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.013,0,0.0001,0.2,0.06);
        FollowerConstants.useSecondaryDrivePID = false;
//        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0, 0, 0

        FollowerConstants.zeroPowerAccelerationMultiplier = 4;
        FollowerConstants.centripetalScaling = 0.00008125;
